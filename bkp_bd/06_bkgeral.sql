-- Backup geral do banco de dados ti18
-- Excluir o usuário caso ele exista
DROP USER IF EXISTS 'iwanez83_ti18'@'localhost';

-- Criar usuário se ele não existir
CREATE USER IF NOT EXISTS 'iwanez83_ti18'@'localhost' 
    IDENTIFIED BY 'senacti18';
GRANT ALL PRIVILEGES ON *.* TO 'iwanez83_ti18'@'localhost' 
    WITH GRANT OPTION;
    FLUSH PRIVILEGES;

-- Excluir o banco de dado caso ele exista
DROP DATABASE IF EXISTS iwanez83_ti18;

-- Criar o banco de dados se não existir
CREATE DATABASE IF NOT EXISTS iwanez83_ti18
...
CREATE TABLE iwanez83_ti18.tbtipos(
...
INSERT INTO iwanez83_ti18.tbtipos
...
-- AUTO INCREMENT da tabela tbtipos
 ALTER TABLE tbtipos
	MODIFY id_tipo INT(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

-- AUTO INCREMENT da tabela tbusuarios  
ALTER TABLE tbusuarios
    MODIFY id_usuario INT(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

-- Limitadores e referências da Chave Estrangeira
-- Limitadores para tbprodutos
ALTER TABLE tbprodutos
